...
.PHONY: help init up down restart ps logs build-and-up down-clean db-only dev-setup dev-be dev-fe migrate-local generate-local seed-local studio-local prisma-studio-local db-seed-dev
